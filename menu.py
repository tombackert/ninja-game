...
class Menu:
    ...
    def levels(self):
        ...
        while True:
            ...
            UI.render_menu_ui_element(self.screen, "backspace to menu", 5, self.WIN_H - 25)
            UI.render_menu_ui_element(self.screen, f"Level: {self.selected_level}", 5, 5)
            UI.render_menu_ui_element(self.screen, "w/a to navigate", self.WIN_W // 2 - 100, self.WIN_H - 25)
    ...
    def store(self):
        ...
        while True:
            ...
            UI.render_menu_ui_element(self.screen, f"${self.cm.coins}", 5, 5)
            ...
            UI.render_menu_ui_element(self.screen, msg, self.WIN_W - 5, 5, "right")
            
            if w_msg_timer > 0:
                UI.render_menu_msg(self.screen, w_msg, self.WIN_W // 2, 400)
                w_msg_timer -= 1

            UI.render_menu_ui_element(self.screen, "backspace to menu", 5, self.WIN_H - 25)
            UI.render_menu_ui_element(self.screen, "w/a to navigate", self.WIN_W // 2 - 100 - 100, self.WIN_H - 25)
